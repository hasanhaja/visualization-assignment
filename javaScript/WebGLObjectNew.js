...
class GLSData {
    ...
    ComputeNormalInfoImage(vec, matx, maty) {
        ...
        for (var i = 0; i < nFaces; i++) {
            ...
            vec3.cross(veca, this.normals[this.face[i][0]], this.vertDerivativesU[this.face[i][0]]);
            vec3.cross(vecb, this.normals[this.face[i][1]], this.vertDerivativesU[this.face[i][1]]);
            vec3.cross(vecc, this.normals[this.face[i][2]], this.vertDerivativesU[this.face[i][2]]);
            vec3.scale(veca, veca, maty[vec[this.face[i][0]][0]][vec[this.face[i][0]][1]]);
            vec3.scale(vecb, vecb, maty[vec[this.face[i][1]][0]][vec[this.face[i][1]][1]]);
            vec3.scale(vecc, vecc, maty[vec[this.face[i][2]][0]][vec[this.face[i][2]][1]]);
            vec3.cross(vecd, this.normals[this.face[i][0]], this.vertDerivativesV[this.face[i][0]]);
            vec3.cross(vece, this.normals[this.face[i][1]], this.vertDerivativesV[this.face[i][1]]);
            vec3.cross(vecf, this.normals[this.face[i][2]], this.vertDerivativesV[this.face[i][2]]);
            vec3.scale(vecd, vecd, matx[vec[this.face[i][0]][0]][vec[this.face[i][0]][1]]);
            vec3.scale(vece, vece, matx[vec[this.face[i][1]][0]][vec[this.face[i][1]][1]]);
            vec3.scale(vecf, vecf, matx[vec[this.face[i][2]][0]][vec[this.face[i][2]][1]]);
